...
public class HelpResource extends OBDResource {
    ...
    public Representation getRepresentation(Variant variant) {
		...
		sb.append("  /{dataSource}/{format}/nodes/{id}/statements/{aspect}/\n");
		sb.append("  /{dataSource}/{format}/nodes/{id}/statements/{aspect}/{relation}\n");
		...
		sb.append("  /{dataSource}/{format}/nodes/{id}/graph\n");
		sb.append("  /{dataSource}/{format}/nodes/{id}/graph/{aspect}\n");
		...
		sb.append("\n");
		sb.append("  /{dataSource}/{format}/nodes/{id}/description\n");
		...
		sb.append("  /{dataSource}/{format}/nodes/{id}/blast\n");
		...
		sb.append("  /{dataSource}/{format}/nodes/{id}/annotation-graph\n");

...
bbop.golr.manager = function (golr_loc, golr_conf_obj){
     ...
     * the clues left in a data url.
     * 
     * This can also (and probably should) be thought of as a
     * "bookmark" function.
     * 
     * Theoretically, you should even be able to use "bookmarks" from
     * alien installations.
     * 
     * This returns true if the query portions of the new and bookmark
     * urls match.
     * 
     * Parameters:
	...
	// If the url has a personality setting, invoke that.

	// Cycle through the rest of the parameters and invoke the
	// appropriate functions to bring them in line.

	// Produce our own url from what we've done. If it matches,
	// return true.
	var qurl = anchor.get_query_url();
	// TODO: cut up new url
	// match them a la testing.

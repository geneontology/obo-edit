...
function LineDiv(aX1, aY1, aX2, aY2, aLineWidth, aColor, aCanvasDiv) {
  ...
  this.lineDiv.style.position = global_pos_style;
...
function newickNodeLabelDiv(aNode, aCanvasDiv) {
  ...
  _div.align = "center";
  _div.valign = "center";
  _div.style.position = global_pos_style;
...
//spot(this.x, this.y, this.tree.canvasDiv);
  ...
  this.drawLabel = function() {
    ...
    if (!aLineDiv.lineDiv) {
      ...
      aLineDiv.lineDiv.style.position = global_pos_style;
...
// Basic drawing functions
  ...
  this.createNodeLabelDivs = function(aNode) {
      // SJC
      // core.kvetch('this.root: ' + this.root);
      // core.kvetch('this.root.id: ' + this.root.id);
      // core.kvetch('aNode: ' + aNode);
      // core.kvetch('aNode.id: ' + aNode.id);
      // core.kvetch('aNode._type: ' + aNode._type);
      // core.kvetch('aNode.sibling: ' + aNode.sibling);
      // core.kvetch('aNode.descendant: ' + aNode.descendant);
      // core.kvetch('aNode.createLabel: ' + aNode.createLabel);
    aNode.createLabel(); // Property of a newick node.
    if (aNode.descendant) {

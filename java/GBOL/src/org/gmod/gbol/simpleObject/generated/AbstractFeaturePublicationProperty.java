 ...
 */
public abstract class AbstractFeaturePublicationProperty  implements java.io.Serializable {
    ...
    public AbstractFeaturePublicationProperty(CVTerm type, FeaturePublication featurePublication, String value, int rank) {
       this.type = type;
       this.featurePublication = featurePublication;
       this.value = value;
       this.rank = rank;

 ...
 */
public abstract class AbstractFeatureCVTerm  implements java.io.Serializable {
    ...
    public AbstractFeatureCVTerm(Publication publication, Feature feature, CVTerm cvterm, boolean isNot, int rank, Set<FeatureCVTermProperty> featureCVTermProperties, Set<FeatureCVTermPublication> featureCVTermPublications, Set<FeatureCVTermDBXref> featureCVTermDBXrefs) {
       this.publication = publication;
       this.feature = feature;
       this.cvterm = cvterm;
       this.isNot = isNot;

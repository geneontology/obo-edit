...
/**
 * AllOnlyRelationshipId generated by hbm2java
 */
public class AllOnlyRelationshipId implements java.io.Serializable {
	...
	public AllOnlyRelationshipId() {
	}

	public AllOnlyRelationshipId(String cls, String relation, String targetCls,
			String ontology) {
		this.cls = cls;
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AllOnlyRelationshipId))
			return false;
		AllOnlyRelationshipId castOther = (AllOnlyRelationshipId) other;

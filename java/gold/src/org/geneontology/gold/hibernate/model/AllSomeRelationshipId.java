...
/**
 * AllSomeRelationshipId generated by hbm2java
 */
public class AllSomeRelationshipId implements java.io.Serializable {
	...
	public AllSomeRelationshipId() {
	}

	public AllSomeRelationshipId(String cls, String relation, String targetCls,
			String ontology) {
		this.cls = cls;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AllSomeRelationshipId))
			return false;
		AllSomeRelationshipId castOther = (AllSomeRelationshipId) other;

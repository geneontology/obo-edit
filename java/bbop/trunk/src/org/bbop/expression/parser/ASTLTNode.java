 ...
 * @version $Id: ASTLTNode.java,v 1.3 2007/09/27 01:02:09 jmr39 Exp $
 */
...
public class ASTLTNode extends SimpleNode {
	...
	//initialize logger
	protected final static Logger logger = Logger.getLogger(ASTLTNode.class);
    /**
    ...
    public Object value(JexlContext jc) throws Exception {
        ...
        throwExpressionException("Invalid comparison : LT ");
        return null;
    }
}

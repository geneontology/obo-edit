...
public abstract class SelectDialog {
	...
	/**
	 * Create a new dialog, which selects a file from the file system with some default settings.
	 * 
	 * @param write write mode, see {@link #LOAD} and {@link #SAVE}.
	 * @param defaultFolder default folder the dialog 
	 * @return dialog
	 * 
	 * @see SelectDialog#getFileSelector(Frame, boolean, String, String, String, String[]) for full options.
	 */
	public static SelectDialog getFileSelector(boolean write, String defaultFolder) {
		return getFileSelector(GUIManager.getManager().getFrame(), write, defaultFolder, "", null, null);
	}

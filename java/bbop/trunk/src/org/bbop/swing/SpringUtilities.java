...
the component's
	...
	Component c = getComponentForCell(row, col, parent, cols);
        return layout.getConstraints(c);
    }

    protected static Component getComponentForCell(int row, int col,
						   Container parent,
						   int cols) {
	int index = 0;
	Component c = null;
    ...
    protected static int getChildCount(Container c) {
	...
	if (rows == -1) {
        ...
        for (int r = 0; r < rows; r++) {
            ...
            for (int c = 0; c < cols; c++) {
		Spring constraint_height = getConstraintsForCell(r, c, parent,
								 cols).
		    getHeight();

		Component comp = getComponentForCell(r, c, parent, cols);

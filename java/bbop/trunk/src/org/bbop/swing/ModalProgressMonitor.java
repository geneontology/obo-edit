 ...
 * <p>
 * 
 * For further documentation and examples see <a
...
public class ModalProgressMonitor extends Object implements Accessible {
	 ...
	 * @see JOptionPane
	 */
	public ModalProgressMonitor(Component parentComponent, Object message,
			String note, int min, int max, boolean modal) {
		this.modal = modal;
		this.min = min;
		this.max = max;

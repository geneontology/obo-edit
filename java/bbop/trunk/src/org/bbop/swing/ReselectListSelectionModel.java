...
/**
 * Reworked version of DefaultListSelectionModel that allows re-selection of
...
public class ReselectListSelectionModel extends DefaultListSelectionModel implements 
	 ...
	 *                if <code>selectionMode</code> is not one of the legal
	 *                values shown above
	...
	private void fireValueChanged() {
		...
		// This is the part I had to change to enable re-selection
...
//		}
	 ...
	 * example, you can query a <code>DefaultListSelectionModel</code>
	 * instance <code>m</code> for its list selection listeners with the
	 * following code:
	 * 
	 * <pre>
	 ...
	 * 
	 * @return the value of the <code>leadAnchorNotificationEnabled</code>
	 *         flag

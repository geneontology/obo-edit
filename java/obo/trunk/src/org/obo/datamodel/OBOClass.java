...
public interface OBOClass extends OBOObject, Type, Comparable {
	...
	public static final OBOClass OBO_CLASS = new OBOClassImpl("obo:TERM","obo:TERM") {
		/**
		 * 
		 */
	...
	public static final OBOClass OBO_PROPERTY = new OBOClassImpl("obo:TYPE","obo:TYPE") {
		/**
		 * 
		 */
	...
	public static final OBOClass OBO_DATATYPE = new OBOClassImpl("obo:datatype", "obo:datatype") {
		/**
		 * 
		 */
	...
	public static final OBOClass OBO_UNKNOWN = new OBOClassImpl("obo:unknown","obo:unknown") {
		/**
		 * 
		 */
	 ...
	 */
	public static final OBOClass OBO_INSTANCE = new OBOClassImpl("obo:instance", "obo:instance") {
		/**
		 * 
		 */
	...
	public static final OBOClass OBO_OBJECT = new OBOClassImpl("obo:object","obo:object") {
		/**
		 * 
		 */
	...
	public static final OBOClass OBO_LINK = new OBOClassImpl("obo:link","obo:link") {
		/**
		 * 
		 */

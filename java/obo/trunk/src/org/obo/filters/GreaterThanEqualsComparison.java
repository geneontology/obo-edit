...
public class GreaterThanEqualsComparison extends AbstractComparison {

	//initialize logger
	protected final static Logger logger = Logger.getLogger(GreaterThanEqualsComparison.class);

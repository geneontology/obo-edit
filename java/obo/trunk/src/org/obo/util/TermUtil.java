...
public class TermUtil {
	...
	/**
	 * Check that the link is marked as inferred using a trailing qualifier.
	 * 
	 * @param link
	 * @return true, if there is a trailing qualifier: is_inferred="true"
	 */
	public static boolean isMarkedAsInferred(Link link) {
		NestedValue nestedValues = link.getNestedValue();
		if (nestedValues != null) {
			Set<PropertyValue> propertyValues = nestedValues.getPropertyValues();
			if (propertyValues != null) {
				for (PropertyValue propertyValue : propertyValues) {
					if ("is_inferred".equals(propertyValue.getProperty())) {

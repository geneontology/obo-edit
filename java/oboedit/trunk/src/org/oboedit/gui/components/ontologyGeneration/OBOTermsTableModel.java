...
//	        { termsParentsOfSelectedLinkedObject, "parent of selected term", null, },
	...
	protected void addFromUserDefinedDefinition(String linkedObjectID, int rank)
	{
	...
	protected void addFromCandidateDefinition(String linkedObjectID, int rank)
	{
		termsFromDefinitions.add(linkedObjectID);
		addTermsRank(linkedObjectID, rank);
		sortingNeeded = true;
	...
	protected void addParentsTermsOfSelectedLinkedObject(Map<String, String> parentTerms)
	{
	...
	/**
	 * Updating linked object in the table (usually in cases where those {@link LinkedObject}s have been changed)
	 * 
	 * @param linkedObjects to update
	 */

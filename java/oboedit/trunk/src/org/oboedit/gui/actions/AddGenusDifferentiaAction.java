...
public class AddGenusDifferentiaAction implements ClickMenuAction {

	//initialize logger
	protected final static Logger logger = Logger.getLogger(AddGenusDifferentiaAction.class);
	...
	public String getName() {
		return "Create new genus-differentia child";
	}
	...
	public HistoryItem execute() {
		...
		item.addItem(new CreateIntersectionLinkHistoryItem(id, OBOProperty.IS_A.getID(),
				target.getID()));

...
public class TagFilterTest extends TestCase {
	...
	//initialize logger
	protected final static Logger logger = Logger.getLogger(TagFilterTest.class);

	public String[] testFiles = { "test_resources/testfile.1.0.obo", "test_resources/testfile.1.2.obo" };

	
	/**
	 * A copy of the SimpleOBORoundTripTest testRoundTrip() method but with the TagFilter 
	 * set to write all tags. 
	 * This tests whether all tags are written as requested.
	 * 
	 * @throws DataAdapterException
	 * @throws IOException
	 */
	public void testRoundtripWithTagFilterWritingAllTags() throws DataAdapterException, IOException {
	...
	/**
	 * A copy of the SimpleOBORoundTripTest testRoundTrip() method but with the TagFilter 
	 * set to write only some tags. 
	 * This tests whether tags are written as requested.
	 * 
	 * @throws DataAdapterException
	 * @throws IOException
	 */
	public void testRoundtripWithTagFilterWritingOnlySomeTags() throws DataAdapterException, IOException {
		for (int i = 0; i < testFiles.length; i++) {
			OBOFileAdapter adapter = new OBOFileAdapter();
			OBOFileAdapter.OBOAdapterConfiguration config = new OBOFileAdapter.OBOAdapterConfiguration();
			config.getReadPaths().add(testFiles[i].toString());

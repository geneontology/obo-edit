...
$ENV{AMIGO_PROJECT_NAME}='goose-test';
$ENV{AMIGO_HTDOCS_PARTIAL_PATH}='/www/toy_9002/htdocs';
$ENV{AMIGO_HTDOCS_PARTIAL_URL}='http://toy.lbl.gov:9002';
$ENV{AMIGO_CGI_PARTIAL_PATH}='/www/toy_9002/cgi-bin';
$ENV{AMIGO_CGI_PARTIAL_URL}='http://toy.lbl.gov:9002/cgi-bin';
$ENV{AMIGO_DATA_PATH}='/www/toy_9002/cgi-bin';
...
$ENV{AMIGO_CGI_URL}='http://toy.lbl.gov:9002/cgi-bin/amigo';
$ENV{AMIGO_TEMP_IMAGE_DIR}='/www/toy_9002/htdocs/amigo/tmp_images';
$ENV{AMIGO_HTDOCS_ROOT_DIR}='/www/toy_9002/htdocs/amigo';
$ENV{AMIGO_HTML_URL}='http://toy.lbl.gov:9002/amigo';
$ENV{AMIGO_CGI_ROOT_DIR}='/www/toy_9002/cgi-bin/amigo';

...
$ENV{AMIGO_PROJECT_NAME}='amigo_release';
...
$ENV{AMIGO_CGI_URL}='http://localhost/cgi-bin/amigo_release';
$ENV{AMIGO_TEMP_IMAGE_DIR}='/srv/www/htdocs/amigo_release/tmp_images';
$ENV{AMIGO_HTDOCS_ROOT_DIR}='/srv/www/htdocs/amigo_release';
$ENV{AMIGO_HTML_URL}='http://localhost/amigo_release';
$ENV{AMIGO_CGI_ROOT_DIR}='/srv/www/cgi-bin/amigo_release';
